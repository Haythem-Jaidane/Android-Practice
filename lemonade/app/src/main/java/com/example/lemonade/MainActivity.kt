...
class MainActivity() : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        var lemonadeView: Int = when(lemonadeState){
    ...
    private fun setViewElements() {
        ...
        var lemonadeText = when(lemonadeState){
            SELECT  -> "Click to select lemon!"
            SQUEEZE -> "Click to juice lemon!"
            DRINK   -> "Click to drink your lemon!"
        ...
        textAction.setText(lemonadeText)
        ...
        var lemonImageId:Int = when(lemonadeState){
            SELECT  -> R.drawable.lemon_tree
            SQUEEZE -> R.drawable.lemon_squeeze
            DRINK   -> R.drawable.lemon_drink
            else    -> R.drawable.lemon_restart
